Change Log
==========
Version 1.0.36 *(2024-03-04)*
----------------------------
* Feature:
- 1. 增加 isEllaFlavor() 方法，判断是否是 咿啦 联名款

Version 1.0.35 *(2024-03-01)*
----------------------------
* Feature:
- 1. 修改 豆神 联名款 的判断逻辑

Version 1.0.34 *(2024-02-28)*
----------------------------
* Feature:
- 1. 增加 isCMFlavor() 方法，判断是否是 移动 定制款

Version 1.0.33 *(2024-02-20)*
----------------------------
* Feature:
- 1. 增加 isDSFlavor() 方法，判断是否是 豆神 联名款

Version 1.0.32 *(2024-01-29)*
----------------------------
* Feature:
- 1. 增加 isT2Series() 方法，判断是否是 T2 系列

Version 1.0.31 *(2023-11-28)*
----------------------------
* Feature:
- 1. 增加 getSalesModel() 方法，获取销售型号
- 2. 增加 getSystemTags() 方法，获取系统标签预留属性
