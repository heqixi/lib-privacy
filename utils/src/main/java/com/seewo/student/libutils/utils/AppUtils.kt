...
class AppUtils {
    ...
    companion object {
        ...
        fun launcherActivityWithAction(context: Context?, action: String?, packageName: String? = null, extras: Bundle? = null) {
        ...
        private fun launcherLocalAppWithIntent(context: Context, intent: Intent): Boolean {
